...
var Layout = function () {
    ...
    function addAjaxifyHistory(url){
	  var history = $.ajaxifyHistory ? $.ajaxifyHistory : [];
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-content').on('click', '.ajaxify', function (e) {
             ...
             * 对url处理 新增了 返回按钮操作
             */
            var $this = $(this),isCache=false,url = (function(){
            	var url = $this.attr("href");
            	if($this.hasClass("back")){
            		url = $.ajaxifyHistory[$.ajaxifyHistory.length-2];
            		isCache = true;
            	}
            	return url;
            })();
        ...
        // handle ajax link within main content
        jQuery('.page-content').on('click', '.ajaform', function (e) {
            e.preventDefault();
            Metronic.scrollTop();
            ...
            $.ajax({
			    ...
			    success: function(data) {
			    	if(data.result.success){
			    		...
			    		alert("请求失败:" + data.result.message);
			    	}
    ...
    return {
        ...
        addAjaxifyHistory : function(url){
        	addAjaxifyHistory(url);
        }
    };
