...
var Resource = function() {
	...
	var initGrideTree = function(roleId, type) {
		var loanTreeUri = '/admin/resource/roleResources?roleId=' + roleId;
		// 输入树
	...
	return {
		initShow : function(roleId, type) {
 			initGrideTree(roleId, type);
			initTreeGridEvent(roleId);
		}
